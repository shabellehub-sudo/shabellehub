...
export async function diffSnapshots(oldText, newText) {
  ...
  // Structured evidence: first removed/added hunk, kept separately from
  // the combined excerpt so downstream consumers (Tool Intelligence
  // Profiles, evidence history) can show a clean before/after without
  // re-parsing the diff text.
