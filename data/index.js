...
export const tools = [
  ...
  },
  {
    ...
    tags: ["Writing","Marketing","Workflow Automation"],
  ...
  },
  {
    ...
    tags: ["Writing","Budget","Short-Form Content"],
  ...
  },
  {
    ...
    price: "Free / from $20mo",
    priceTier: "freemium",
    desc: "AI-native code editor — rebranded Devin Desktop in 2026 under Cognition AI — with agentic \"Cascade\" flows that can plan and execute multi-file changes across your codebase.",
    longDesc: "Windsurf was rebranded to Devin Desktop in 2026 after Cognition AI acquired the product; the underlying editor and its capabilities carried over unchanged, only the name and branding changed. It is a standalone AI-native code editor combining fast autocomplete and chat with \"Cascade\" — an agentic mode that can plan out a multi-step task, make coordinated edits across multiple files, run terminal commands, and iterate based on the results, with the developer reviewing changes along the way. This makes it a strong option for tasks like implementing a feature that touches several files, or refactoring a pattern across a codebase. The free tier remains available at $0; paid plans now start at $20/month for Pro, with Max ($200/month) and Team ($80/month + $40/month per seat) tiers above it, plus a custom Enterprise plan. Very large monorepos can still slow down the initial indexing step.",
    ...
    seoKeywords: ["windsurf ai review","windsurf vs cursor","windsurf editor pricing","codeium windsurf","devin desktop","windsurf devin desktop rebrand"],
  ...
  },
  {
    ...
    badge: "Discontinued",
    rating: 4.6,
    price: "Discontinued — model still available via ChatGPT Plus/Pro",
    priceTier: "freemium",
    desc: "OpenAI's standalone text-to-video app was discontinued on April 26, 2026 (API sunset September 24, 2026). The underlying Sora model remains available through ChatGPT Plus/Pro.",
    longDesc: "Sora was OpenAI's standalone video generation app, featuring a social feed and a \"Cameo\" feature for inserting your likeness into generated clips. OpenAI discontinued the Sora web and app experiences on April 26, 2026, citing high operating costs relative to revenue. The Sora API remains available to developers until its scheduled shutdown on September 24, 2026. As of publication, OpenAI has not announced a successor standalone video product, though the underlying Sora video generation model reportedly remains accessible through ChatGPT Plus and Pro subscriptions. Users with existing content were advised to export it via OpenAI's official export tool before their respective shutdown dates.",
    ...
    cons: ["Standalone app and website discontinued as of April 26, 2026","API access ends September 24, 2026 with no announced successor","Heavier usage historically required ChatGPT Plus/Pro","Content moderation could reject some prompts"],
  ...
  },
  {
    ...
    rating: 4.2,
    price: "From $39/seat/mo (no free tier)",
    priceTier: "paid",
    ...
    hot: false,
    featured: false,
    pros: ["Strong privacy options including local/on-prem deployment","Trained on permissively-licensed code to reduce IP risk","Works across many popular IDEs","IP indemnification and air-gapped deployment options"],
  ...
  },
  {
    ...
    rating: 4.3,
    price: "Enterprise only — contracts starting around $16K/year",
    priceTier: "paid",
    ...
    hot: false,
    featured: false,
    pros: ["Excellent context across large, multi-repo codebases","Built on proven Sourcegraph code-search technology","Supports multiple LLMs (Claude, GPT, Gemini) under the hood","SOC 2 compliant with self-hosted/air-gapped deployment options"],
    cons: ["No free or individual-developer tier as of 2025 — Enterprise only, from $59/user/month with annual contracts","Full value depends on Sourcegraph code search/indexing setup","Smaller community than GitHub Copilot"],
  ...
  },
  {
    ...
    hot: false,
    featured: false,
    pros: ["Deep integration with AWS services and documentation","Agentic mode can implement features and open PRs","Built-in security scanning","Existing subscribers can keep adding seats through the 2027 transition window"],
    cons: ["AWS is discontinuing Amazon Q Developer IDE plugins as of April 30, 2027 — AWS recommends migrating to its newer tool, Kiro","Most valuable for teams heavily invested in AWS","Per-user enterprise pricing adds up for larger teams"],
  ...
  },
  {
    ...
    name: "Aider",
    category: "Coding",
    badge: "Community Score",
    rating: 4.2,
    price: "Free (open source, pay for API usage)",
    priceTier: "free",
    desc: "Terminal-based open-source AI pair programmer that edits your local git repo directly from the command line.",
    longDesc: "Aider runs in your terminal and edits files in your actual git repository, committing changes as it goes so every AI edit is tracked in version history. It appeals to developers who prefer a command-line workflow over a GUI editor and want tight control over what gets changed. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Coding","CLI","Open Source"],
    affiliateLink: "https://aider.chat/?ref=shabellehub",
    website: "https://aider.chat",
    hot: false,
    featured: false,
    pros: ["Git-native workflow","Terminal-first for CLI fans","Open source and model-agnostic"],
    cons: ["No GUI — command-line only","You pay your own model API costs"],
    useCases: ["CLI-first developers","Git-tracked AI edits","Scripting and automation"],
    seoKeywords: ["aider ai review","terminal ai coding"],
    alternatives: [],
  },
  {
    id: 66,
    ...
    price: "From $39mo",
    priceTier: "paid",
    desc: "AI copywriting tool that scores generated copy on predicted performance, aimed at data-driven marketing teams.",
    longDesc: "Anyword's distinguishing feature is its predictive performance scoring — it estimates how well a given piece of copy might perform based on patterns from past campaigns, which appeals to marketers who want to A/B test at the generation stage rather than only after publishing. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Writing","Marketing","Analytics"],
    affiliateLink: "https://anyword.com/?ref=shabellehub",
    website: "https://anyword.com",
    hot: false,
    featured: false,
    pros: ["Predictive performance scoring","Useful for A/B testing copy","Marketing-team-oriented features"],
    cons: ["No free tier","Best value needs marketing-specific use cases"],
    useCases: ["Performance-driven ad copy","Email subject line testing","Data-driven marketing teams"],
    seoKeywords: ["anyword review","ai copy performance scoring"],
    alternatives: [],
  },
  {
    id: 67,
    ...
    badge: null,
    rating: 4.2,
    price: "Add-on from $5 per user/mo",
    priceTier: "paid",
    desc: "AI features built into the ClickUp project management platform (rebranded from \"ClickUp AI\" to \"ClickUp Brain\"), including task summaries, writing help, autonomous \"Super Agents,\" and automation.",
    longDesc: "ClickUp AI is an add-on layer inside the ClickUp project management suite that summarizes tasks and documents, drafts updates, and can trigger automations based on natural-language requests. Its main advantage is that it lives inside a tool teams may already use for task tracking, rather than requiring a separate app.",
    tags: ["Project Management","Productivity","Automation"],
    affiliateLink: "https://clickup.com/ai?ref=shabellehub",
    website: "https://clickup.com/ai",
    hot: false,
    featured: false,
    pros: ["Integrated directly into existing workflows","Good task/document summarization","Broad automation options"],
    cons: ["Add-on cost on top of ClickUp plan","Can feel overwhelming with all features enabled"],
    useCases: ["Task and document summaries","Project status updates","Workflow automation"],
    seoKeywords: ["clickup ai review","ai project management","clickup ai vs notion ai"],
    alternatives: ["notion-ai","motion","taskade"],
  },
  {
    id: 68,
    slug: "continue-dev",
    ...
    priceTier: "free",
    desc: "Open-source AI code assistant that lets you plug in your own model (including local/self-hosted LLMs) inside VS Code or JetBrains.",
    longDesc: "Continue.dev is popular with developers who want control over which model powers their AI assistant — it supports OpenAI, Anthropic, and local models via Ollama, among others. Because it's open source, teams can self-host it entirely for full data control, at the cost of more setup work than a plug-and-play tool. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Coding","Open Source","Self-Hosted"],
    affiliateLink: "https://continue.dev/?ref=shabellehub",
    website: "https://continue.dev",
    hot: false,
    featured: false,
    pros: ["Bring-your-own-model flexibility","Fully open source","Works with local LLMs"],
    cons: ["Requires more setup than closed tools","Quality depends on the model you choose"],
    useCases: ["Privacy-conscious teams","Local LLM users","Customizable workflows"],
    seoKeywords: ["continue.dev review","open source ai coding assistant"],
    alternatives: [],
  },
  {
    id: 69,
    ...
    price: "From $19mo",
    priceTier: "paid",
    desc: "AI copywriting platform aimed at ecommerce teams, generating product descriptions and ad copy at scale.",
    longDesc: "Copysmith focuses on ecommerce-specific content needs — bulk product description generation, Shopify/BigCommerce integrations, and ad copy variations for testing. It's built for catalogs with many SKUs rather than single-piece content creation. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Writing","Ecommerce","Marketing"],
    affiliateLink: "https://copysmith.ai/?ref=shabellehub",
    website: "https://copysmith.ai",
    hot: false,
    featured: false,
    pros: ["Ecommerce platform integrations","Bulk generation for large catalogs","Ad copy variant testing"],
    cons: ["Narrow focus on ecommerce use cases","No free tier"],
    useCases: ["Product description generation","Ecommerce ad copy","Catalog content at scale"],
    seoKeywords: ["copysmith review"],
    alternatives: [],
  },
  {
    id: 70,
    ...
    badge: "Community Score",
    rating: 4.4,
    price: "Included with ChatGPT Plus ($20mo)",
    priceTier: "paid",
    desc: "OpenAI's image generator, integrated into ChatGPT, known for strong prompt-following and text rendering in images.",
    longDesc: "DALL·E 3 is accessed mainly through ChatGPT Plus, which lets you refine images conversationally rather than through a separate interface. It tends to follow detailed prompts more literally than Midjourney and is notably better at rendering readable text within images. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Image Generation","OpenAI"],
    affiliateLink: "https://openai.com/index/dall-e-3/?ref=shabellehub",
    website: "https://openai.com/index/dall-e-3/",
    hot: false,
    featured: false,
    pros: ["Excellent prompt adherence","Good at rendering text in images","Conversational refinement via ChatGPT"],
    cons: ["Requires ChatGPT Plus subscription","Less stylized than Midjourney by default"],
    useCases: ["Precise prompt-following needs","Images with text/logos","ChatGPT-integrated workflows"],
    seoKeywords: ["dalle 3 review","dalle vs midjourney"],
    alternatives: [],
  },
  {
    id: 71,
    ...
    price: "Free / $5-30mo",
    priceTier: "freemium",
    desc: "AI website builder that generates full responsive websites from a text prompt inside Framer's design tool.",
    longDesc: "Framer AI lets you describe a website and generates a full, editable, responsive site built on Framer's no-code design canvas. Output tends to be production-ready with real animations and interactions, not just a static mockup. Best for solo founders and small teams who want a polished site fast without hiring a developer.",
    tags: ["Website Builder","No-Code","Design"],
    affiliateLink: "https://www.framer.com/ai/?ref=shabellehub",
    website: "https://www.framer.com/ai",
    hot: false,
    featured: false,
    pros: ["Generates full sites quickly","Production-ready output","Strong design flexibility"],
    cons: ["Can require manual cleanup","Pricing scales with traffic"],
    useCases: ["Landing pages","Portfolio sites","Small business websites"],
    seoKeywords: ["framer ai review","ai website builder","framer ai vs webflow"],
    alternatives: ["uizard","canva-magic-studio"],
  },
  {
    id: 72,
    slug: "frase",
    ...
    price: "From $15mo",
    priceTier: "paid",
    desc: "AI content research and writing tool that analyzes top-ranking search results to guide SEO-focused articles.",
    longDesc: "Frase pulls in top-ranking pages for a target keyword and builds a content brief/outline based on what's already ranking, then helps draft the article around that structure. It's aimed squarely at SEO content teams rather than general writing. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Writing","SEO","Research"],
    affiliateLink: "https://www.frase.io/?ref=shabellehub",
    website: "https://www.frase.io",
    hot: false,
    featured: false,
    pros: ["SERP-based content briefs","Strong SEO research features","Good outline generation"],
    cons: ["No free tier","Narrow focus on SEO content"],
    useCases: ["SEO article research","Content brief creation","Competitive content analysis"],
    seoKeywords: ["frase io review","ai seo content tool"],
    alternatives: [],
  },
  {
    id: 73,
    ...
    badge: "Community Score",
    rating: 4.4,
    price: "Free tier / Premium from $12mo",
    priceTier: "freemium",
    desc: "Widely used AI writing assistant for grammar, tone, and clarity, with a browser extension that works almost anywhere online.",
    longDesc: "Grammarly checks grammar, spelling, tone, and clarity as you write, with a browser extension and desktop app that work across email, docs, and social media. Newer AI features let it generate and rewrite text directly, moving it beyond pure proofreading. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Writing","Grammar","Proofreading"],
    affiliateLink: "https://www.grammarly.com/?ref=shabellehub",
    website: "https://www.grammarly.com",
    hot: false,
    featured: false,
    pros: ["Works nearly everywhere online","Strong grammar/tone detection","Widely trusted, established product"],
    cons: ["Full AI writing features cost extra","Can be overly aggressive with suggestions"],
    useCases: ["Everyday proofreading","Professional email polish","Tone adjustment"],
    seoKeywords: ["grammarly review","grammarly ai features"],
    alternatives: [],
  },
  {
    id: 74,
    ...
    badge: null,
    rating: 4.3,
    price: "Free (X Premium) / $8-16mo",
    priceTier: "freemium",
    desc: "xAI's chatbot integrated with X (Twitter), known for real-time access to X posts and a more unfiltered conversational tone.",
    longDesc: "Grok is built by xAI and is tightly integrated with the X platform, giving it access to real-time posts and trending topics that most chatbots cannot see. It leans toward a more direct, less filtered response style than competitors, and ships fast iterative model updates. Best suited for users who already live on X and want current-events context baked into their chatbot.",
    tags: ["Chatbot","Real-time Info","X Integration"],
    affiliateLink: "https://x.ai/grok?ref=shabellehub",
    website: "https://x.ai/grok",
    hot: false,
    featured: false,
    pros: ["Real-time X/Twitter data access","Less restrictive responses","Fast iterative model updates"],
    cons: ["Requires X Premium subscription","Smaller context window than top competitors"],
    useCases: ["Real-time news and trends","Casual conversation","Social media context"],
    seoKeywords: ["grok ai review","grok vs chatgpt","xai grok"],
    alternatives: ["chatgpt","claude","gemini"],
  },
  {
    id: 75,
    ...
    badge: null,
    rating: 4.5,
    price: "Free / $36+ per user/mo",
    priceTier: "freemium",
    desc: "Collaborative data notebook with AI assistance for SQL, Python analysis, and building interactive data apps.",
    longDesc: "Hex combines a notebook interface with AI-assisted SQL and Python generation, aimed at data teams who want to go from raw data to a shareable interactive report or app quickly. Its collaboration features, including live co-editing, comments, and versioning, make it a strong fit for teams rather than solo analysts.",
    tags: ["Data Analysis","SQL","Notebooks"],
    affiliateLink: "https://hex.tech/?ref=shabellehub",
    website: "https://hex.tech",
    hot: false,
    featured: false,
    pros: ["Strong AI-assisted SQL/Python","Great for team collaboration","Interactive data apps"],
    cons: ["Steeper learning curve","Pricing aimed at teams, not individuals"],
    useCases: ["Data exploration","Team dashboards","SQL/Python analysis"],
    seoKeywords: ["hex review","hex tech ai","hex vs julius ai"],
    alternatives: ["julius-ai","akkio"],
  },
  {
    id: 76,
    slug: "ink-editor",
    ...
    price: "From $39mo",
    priceTier: "paid",
    desc: "AI writing tool combining content generation with real-time SEO scoring as you write.",
    longDesc: "INK Editor blends drafting assistance with a live SEO score that updates as you write, aiming to help content creators optimize for search without switching between separate writing and SEO tools. It supports a wide range of content templates beyond blog posts. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Writing","SEO","Content"],
    affiliateLink: "https://inkforall.com/?ref=shabellehub",
    website: "https://inkforall.com",
    hot: false,
    featured: false,
    pros: ["Real-time SEO scoring while writing","Wide template library","Combines drafting and optimization"],
    cons: ["Pricier tier structure","Interface less polished than newer tools"],
    useCases: ["SEO-optimized blog writing","Content scoring","Marketing content at scale"],
    seoKeywords: ["ink editor review"],
    alternatives: [],
  },
  {
    id: 77,
    ...
    badge: "Community Score",
    rating: 4,
    price: "Free (limited) / from $10mo",
    priceTier: "freemium",
    desc: "Native AI assistant built into JetBrains IDEs like IntelliJ IDEA, PyCharm, and WebStorm.",
    longDesc: "JetBrains AI Assistant is integrated directly into the JetBrains IDE family, offering code completion, chat, commit message generation, and documentation lookup without leaving the editor. Because it's first-party, it tends to understand JetBrains-specific refactoring tools better than third-party plugins. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Coding","IDE","JetBrains"],
    affiliateLink: "https://www.jetbrains.com/ai/?ref=shabellehub",
    website: "https://www.jetbrains.com/ai/",
    hot: false,
    featured: false,
    pros: ["Deep JetBrains integration","Commit message generation","Familiar UI for JetBrains users"],
    cons: ["Only useful if you already use JetBrains IDEs","Pricing layered on top of IDE license"],
    useCases: ["Java/Kotlin development","Python in PyCharm","JetBrains power users"],
    seoKeywords: ["jetbrains ai assistant review"],
    alternatives: [],
  },
  {
    id: 78,
    ...
    price: "From $5mo",
    priceTier: "paid",
    desc: "AI video generation tool aimed at music videos and stylized animated content synced to audio.",
    longDesc: "Kaiber specializes in turning images, video, or audio into stylized animated video, with particular popularity among musicians creating music videos and visualizers without a traditional production budget. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Video","Music","Animation"],
    affiliateLink: "https://kaiber.ai/?ref=shabellehub",
    website: "https://kaiber.ai",
    hot: false,
    featured: false,
    pros: ["Good for music-synced video","Distinctive stylized output","Affordable entry pricing"],
    cons: ["No free tier for real projects","Narrower use case than general video tools"],
    useCases: ["Music video creation","Audio-reactive visuals","Stylized animation"],
    seoKeywords: ["kaiber ai review"],
    alternatives: [],
  },
  {
    id: 79,
    ...
    price: "Free / $10-48mo",
    priceTier: "freemium",
    desc: "Real-time AI image and video generation tool with live canvas editing and upscaling.",
    longDesc: "Krea stands out for its real-time generation preview, as you sketch or adjust a prompt the output updates live, making it fast to iterate toward a final image. It also includes strong AI upscaling and video generation tools. Popular with designers who want a tighter feedback loop than typical prompt-and-wait image generators.",
    tags: ["Image Generation","Real-time","Upscaling"],
    affiliateLink: "https://krea.ai/?ref=shabellehub",
    website: "https://krea.ai",
    hot: false,
    featured: false,
    pros: ["Real-time generation preview","Strong upscaling tools","Good for iterative design"],
    cons: ["Credits system can get expensive","Learning curve for advanced features"],
    useCases: ["Concept art iteration","Image upscaling","AI video generation"],
    seoKeywords: ["krea ai review","real-time ai image generator","krea vs midjourney"],
  ...
  },
  {
    ...
    badge: "Community Score",
    rating: 4,
    price: "Free tier / Pro from $16.66mo",
    priceTier: "freemium",
    desc: "AI-native document editor built for long-form writing, with AI suggestions woven directly into the drafting process.",
    longDesc: "Lex is a from-scratch document editor (not a plugin) designed around AI-assisted long-form writing — essays, articles, and reports — with inline suggestions and a chat panel for brainstorming without leaving the document. It appeals to writers who want a purpose-built app rather than an add-on to Word or Google Docs. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Writing","Editor","Long-form"],
    affiliateLink: "https://lex.page/?ref=shabellehub",
    website: "https://lex.page",
    hot: false,
    featured: false,
    pros: ["Purpose-built editor, not a plugin","Good for long-form drafting","Clean, distraction-free interface"],
    cons: ["Smaller ecosystem than Docs/Word","Fewer integrations with other tools"],
    useCases: ["Long-form article drafting","Essay writing","Distraction-free writing sessions"],
    seoKeywords: ["lex app review","ai document editor"],
    alternatives: [],
  },
  {
    id: 81,
    ...
    badge: "Community Score",
    rating: 3.7,
    price: "Free tier / Pro from $10mo",
    priceTier: "freemium",
    desc: "AI-powered note-taking app that automatically organizes and surfaces relevant notes without manual folders or tags.",
    longDesc: "Mem aims to remove manual organization from note-taking — instead of folders and tags, it uses AI to surface relevant past notes automatically when they're related to what you're currently writing, betting that automatic retrieval beats manual filing. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Productivity","Notes","Knowledge Management"],
    affiliateLink: "https://get.mem.ai/?ref=shabellehub",
    website: "https://get.mem.ai",
    hot: false,
    featured: false,
    pros: ["No manual organization needed","AI-surfaced related notes","Clean, minimal writing interface"],
    cons: ["Trusting automatic organization takes adjustment","Smaller ecosystem than Notion/Obsidian"],
    useCases: ["Personal knowledge management","Quick note capture","Automatic note connections"],
    seoKeywords: ["mem ai review"],
    alternatives: [],
  },
  {
    id: 82,
    ...
    priceTier: "freemium",
    desc: "Free chatbot from French AI lab Mistral, with strong multilingual support and fast responses.",
    longDesc: "Le Chat is Mistral AI's consumer chatbot, built on the company's open-weight model family. It is particularly strong for multilingual conversations, especially European languages, and offers a generous free tier since Mistral also open-sources many of its underlying models. It is a solid alternative for users who want a fast, privacy-conscious European option.",
    tags: ["Chatbot","Open Source","Multilingual"],
    affiliateLink: "https://chat.mistral.ai/?ref=shabellehub",
    website: "https://chat.mistral.ai",
    hot: false,
    featured: false,
    pros: ["Fast responses","Strong multilingual support","Open-weight models available"],
    cons: ["Smaller ecosystem than ChatGPT/Claude","Fewer third-party integrations"],
    useCases: ["Multilingual conversation","Quick Q&A","Privacy-conscious chat"],
    seoKeywords: ["mistral le chat review","mistral ai chatbot","le chat vs chatgpt"],
  ...
  },
  {
    ...
    price: "Free / $9.99mo",
    priceTier: "freemium",
    desc: "AI photo editing app specializing in background removal and product photo generation for e-commerce.",
    longDesc: "Photoroom is built around one core job: making product and portrait photos look professional in seconds. Its background removal is fast and accurate on mobile, and it can generate studio-style backgrounds for e-commerce listings automatically. Less suited for from-scratch creative generation, but excellent for anyone selling products online.",
    tags: ["Image Editing","Background Removal","E-commerce"],
    affiliateLink: "https://www.photoroom.com/?ref=shabellehub",
    website: "https://www.photoroom.com",
    hot: false,
    featured: false,
    pros: ["Excellent background removal","Fast mobile app","Good for product photography"],
    cons: ["Limited free tier","Less suited for from-scratch generation"],
    useCases: ["E-commerce product photos","Background removal","Social media graphics"],
    seoKeywords: ["photoroom review","ai background remover","photoroom for ecommerce"],
  ...
  },
  {
    ...
    price: "Free",
    priceTier: "free",
    desc: "AI-powered snippet manager that captures, organizes, and enriches code snippets with context across your workflow.",
    longDesc: "Pieces focuses on a different problem than most AI coding tools — instead of writing new code, it helps you capture and re-find useful snippets, complete with AI-generated context about where and why they were saved. It runs locally with on-device processing options. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Coding","Productivity","Snippets"],
    affiliateLink: "https://pieces.app/?ref=shabellehub",
    website: "https://pieces.app",
    hot: false,
    featured: false,
    pros: ["On-device processing option","Good for snippet reuse","Cross-tool context capture"],
    cons: ["Different use case than code generation","Learning curve for full feature set"],
    useCases: ["Snippet management","Cross-project code reuse","Documentation capture"],
    seoKeywords: ["pieces for developers review"],
    alternatives: [],
  },
  {
    id: 85,
    ...
    badge: null,
    rating: 4.3,
    price: "Free / $11.99-23.99mo",
    priceTier: "freemium",
    desc: "AI podcast recording and editing platform with studio-quality voice enhancement and text-based editing.",
    longDesc: "Podcastle lets creators record remote interviews in-browser, then edit the resulting audio like a text document, deleting a sentence removes it from the audio track. Its AI voice enhancement cleans up room noise and inconsistent mic quality automatically, which matters a lot for creators recording from home setups.",
    tags: ["Podcasting","Audio Editing","Voice Enhancement"],
    affiliateLink: "https://podcastle.ai/?ref=shabellehub",
    website: "https://podcastle.ai",
    hot: false,
    featured: false,
    pros: ["Text-based audio editing","Studio-quality noise removal","Built-in remote recording"],
    cons: ["Best features gated behind paid plans","Video features less mature than audio"],
    useCases: ["Podcast recording","Remote interviews","Audio cleanup"],
    seoKeywords: ["podcastle review","ai podcast editor","podcastle vs descript"],
    alternatives: ["descript","fireflies"],
  },
  {
    id: 86,
    slug: "quillbot",
    ...
    badge: "Community Score",
    rating: 4,
    price: "Free tier / Premium from $9.95mo",
    priceTier: "freemium",
    desc: "AI paraphrasing and grammar tool widely used by students and professionals for rewriting and polishing text.",
    longDesc: "QuillBot's core feature is paraphrasing — rewriting sentences in different tones or styles while preserving meaning — alongside grammar checking, summarizing, and citation tools. It's popular in academic contexts for polishing drafts, though users should check their institution's AI-use policy. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Writing","Grammar","Academic"],
    affiliateLink: "https://quillbot.com/?ref=shabellehub",
    website: "https://quillbot.com",
    hot: false,
    featured: false,
    pros: ["Strong paraphrasing engine","Grammar + citation tools bundled","Generous free tier"],
    cons: ["Paraphrasing can drift from original meaning","Premium needed for full features"],
    useCases: ["Academic writing polish","Paraphrasing and rewriting","Grammar checking"],
    seoKeywords: ["quillbot review","best ai paraphrasing tool"],
    alternatives: [],
  },
  {
    id: 87,
    ...
    price: "Free tier / Pro from $10mo",
    priceTier: "freemium",
    desc: "AI design tool combining image generation with vector output, aimed at brand and product design work.",
    longDesc: "Recraft differentiates itself by generating editable vector graphics (not just raster images) alongside raster output, plus tools for maintaining consistent brand colors and styles across generations — useful for design teams producing icon sets or brand assets. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Image Generation","Design","Vector"],
    affiliateLink: "https://www.recraft.ai/?ref=shabellehub",
    website: "https://www.recraft.ai",
    hot: false,
    featured: false,
    pros: ["Vector output option","Brand style consistency tools","Good for icon/asset sets"],
    cons: ["Smaller community than major competitors","Vector quality varies by complexity"],
    useCases: ["Brand asset generation","Icon set design","Vector graphic needs"],
    seoKeywords: ["recraft ai review"],
    alternatives: [],
  },
  {
    id: 88,
    ...
    badge: null,
    rating: 4.2,
    price: "Free / $15+ per user/mo",
    priceTier: "freemium",
    desc: "AI-powered spreadsheet that connects to live data sources and lets you build reports and dashboards with natural language.",
    longDesc: "Rows keeps the familiar spreadsheet grid but adds native connections to APIs, marketing platforms, and databases, plus an AI layer that can write formulas or summarize data from a plain-language request. It is aimed at teams who live in spreadsheets but are tired of manual data pulls and CSV exports.",
    tags: ["Spreadsheet","Data Analysis","Automation"],
    affiliateLink: "https://rows.com/?ref=shabellehub",
    website: "https://rows.com",
    hot: false,
    featured: false,
    pros: ["Natural language formulas","Live data connections","Familiar spreadsheet interface"],
    cons: ["Fewer advanced functions than Excel","Smaller integration library"],
    useCases: ["Live marketing dashboards","Automated reporting","Data pulls from APIs"],
    seoKeywords: ["rows review","ai spreadsheet tool","rows vs excel"],
    alternatives: ["hex","akkio"],
  },
  {
    id: 89,
    ...
    price: "Free",
    priceTier: "free",
    desc: "AI-powered academic search engine that helps researchers discover and navigate scientific literature.",
    longDesc: "Semantic Scholar uses AI to enhance traditional academic search with features like influential citation highlighting, TLDR summaries of papers, and topic-based paper recommendations, making it a common starting point for academic literature discovery. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Research","Academic","Free"],
    affiliateLink: "https://www.semanticscholar.org/?ref=shabellehub",
    website: "https://www.semanticscholar.org",
    hot: false,
    featured: false,
    pros: ["Completely free","TLDR paper summaries","Influential-citation highlighting"],
    cons: ["Coverage varies by field","Less conversational than newer AI research tools"],
    useCases: ["Academic paper discovery","Citation tracking","Literature review starting point"],
    seoKeywords: ["semantic scholar review"],
    alternatives: [],
  },
  {
    id: 90,
    ...
    badge: "Community Score",
    rating: 3.8,
    price: "Free tier / Pro from $30mo",
    priceTier: "freemium",
    desc: "All-in-one AI content platform combining writing, basic design, and social media scheduling in one workspace.",
    longDesc: "Simplified bundles AI copywriting with lightweight design tools and social post scheduling, aiming at small businesses and solo marketers who want one subscription instead of separate writing, design, and scheduling tools. Each individual feature is less deep than a dedicated specialist tool. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Writing","Design","Social Media"],
    affiliateLink: "https://simplified.com/?ref=shabellehub",
    website: "https://simplified.com",
    hot: false,
    featured: false,
    pros: ["Combines writing, design, and scheduling","Good value for small businesses","Generous free tier for light use"],
    cons: ["Each tool is less powerful than dedicated specialists","Can feel spread thin across features"],
    useCases: ["Small business marketing","Solo-founder content workflows","Social media content batches"],
    seoKeywords: ["simplified ai review","all in one content tool"],
    alternatives: [],
  },
  {
    id: 91,
    ...
    badge: "Community Score",
    rating: 4.2,
    price: "Free (self-hosted) / hosted options vary",
    priceTier: "free",
    desc: "Open-source image generation model that can be self-hosted or run through various commercial interfaces.",
    longDesc: "Stable Diffusion's defining feature is openness — the model weights are publicly available, letting developers self-host, fine-tune, and build custom applications on top of it. This flexibility comes with more technical setup than fully-hosted competitors, though many third-party apps now offer simplified interfaces. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Image Generation","Open Source"],
    affiliateLink: "https://stability.ai/?ref=shabellehub",
    website: "https://stability.ai",
    hot: false,
    featured: false,
    pros: ["Open source and self-hostable","Highly customizable and fine-tunable","Large ecosystem of tools built on it"],
    cons: ["Self-hosting requires technical setup","Quality varies by which fine-tune/interface you use"],
    useCases: ["Developers building AI products","Custom model fine-tuning","Privacy-conscious image generation"],
    seoKeywords: ["stable diffusion review","open source image generation"],
    alternatives: [],
  },
  {
    id: 92,
    ...
    price: "From $19mo",
    priceTier: "paid",
    desc: "AI writing tool built specifically for fiction writers, with features for brainstorming, description, and story continuation.",
    longDesc: "Unlike most general-purpose AI writers, Sudowrite is built around the specific needs of novelists — features like 'Describe' for sensory detail, 'Brainstorm' for plot ideas, and story-bible tracking for character/world consistency across long manuscripts. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Writing","Fiction","Creative"],
    affiliateLink: "https://www.sudowrite.com/?ref=shabellehub",
    website: "https://www.sudowrite.com",
    hot: false,
    featured: false,
    pros: ["Purpose-built for fiction","Story-bible consistency tracking","Strong descriptive-writing features"],
    cons: ["Not useful for non-fiction/business writing","No free tier"],
    useCases: ["Novel writing","Creative brainstorming","Fiction editing assistance"],
    seoKeywords: ["sudowrite review","ai for novel writing"],
    alternatives: [],
  },
  {
    id: 93,
    ...
    price: "$30/mo",
    priceTier: "paid",
    desc: "AI-powered email client focused on speed, with AI-generated replies, summaries, and inbox triage.",
    longDesc: "Superhuman is a keyboard-driven email client layered on top of Gmail or Outlook, designed to get you through your inbox faster. Its AI features write draft replies in your voice, summarize long threads, and automatically triage incoming mail. The tradeoff is a premium price point aimed squarely at busy professionals, not casual email users.",
    tags: ["Email","Productivity","AI Assistant"],
    affiliateLink: "https://superhuman.com/?ref=shabellehub",
    website: "https://superhuman.com",
    hot: false,
    featured: false,
    pros: ["Very fast keyboard-driven interface","AI email summaries and replies","Split inbox triage"],
    cons: ["Expensive compared to standard email apps","Only supports Gmail and Outlook"],
    useCases: ["High-volume email management","Fast inbox triage","AI-drafted replies"],
    seoKeywords: ["superhuman review","ai email client","superhuman vs gmail"],
    alternatives: ["notion-ai","motion"],
  },
  {
    id: 94,
    slug: "supermaven",
    ...
    badge: "Community Score",
    rating: 4,
    price: "Free tier / Pro $10mo",
    priceTier: "freemium",
    desc: "AI code completion tool built around a very large context window, aimed at fast, low-latency autocomplete.",
    longDesc: "Supermaven's main selling point is speed combined with a context window large enough to consider an entire file or several related files at once. It integrates as a lightweight plugin in popular editors and focuses purely on completion rather than chat or agentic features. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Coding","Autocomplete"],
    affiliateLink: "https://supermaven.com/?ref=shabellehub",
    website: "https://supermaven.com",
    hot: false,
    featured: false,
    pros: ["Very fast completions","Large context window","Lightweight plugin"],
    cons: ["No chat/agent features","Newer, smaller community"],
    useCases: ["Fast autocomplete","Large-file editing","Minimalist workflow"],
    seoKeywords: ["supermaven review","fastest ai autocomplete"],
    alternatives: [],
  },
  {
    id: 95,
    ...
    badge: "Community Score",
    rating: 3.8,
    price: "Free tier / Pro from $8mo",
    priceTier: "freemium",
    desc: "AI-powered task and project management tool combining to-do lists, docs, and mind maps with built-in AI agents.",
    longDesc: "Taskade combines several productivity formats (task lists, docs, mind maps, calendars) into one workspace, with AI agents that can generate project plans or automate repetitive workflow steps directly inside the app. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Productivity","Project Management"],
    affiliateLink: "https://www.taskade.com/?ref=shabellehub",
    website: "https://www.taskade.com",
    hot: false,
    featured: false,
    pros: ["Multiple formats in one workspace","Built-in AI project planning","Generous free tier"],
    cons: ["Can feel feature-heavy for simple needs","Less polished than single-purpose tools"],
    useCases: ["Project planning","Team task management","Mind mapping with AI assistance"],
    seoKeywords: ["taskade review"],
    alternatives: [],
  },
  {
    id: 96,
    ...
    price: "Free / $12-39mo",
    priceTier: "freemium",
    desc: "AI-powered UI/UX design tool that turns sketches, screenshots, or text prompts into editable app and web mockups.",
    longDesc: "Uizard is aimed at non-designers who need to communicate a product idea quickly. It can turn a hand-drawn sketch or a screenshot of an existing app into an editable digital mockup, or generate one from a text prompt. It is not a replacement for Figma-level design control, but it dramatically speeds up the earliest stage of prototyping.",
    tags: ["UI Design","Prototyping","No-Code"],
    affiliateLink: "https://uizard.io/?ref=shabellehub",
    website: "https://uizard.io",
    hot: false,
    featured: false,
    pros: ["Fast prototyping from sketches","Good for non-designers","Theme customization"],
    cons: ["Limited design flexibility vs Figma","Basic export options"],
    useCases: ["Rapid prototyping","Sketch-to-mockup conversion","Design handoff for non-designers"],
    seoKeywords: ["uizard review","sketch to design ai","uizard vs figma"],
    alternatives: ["framer-ai","canva-magic-studio"],
  },
  {
    id: 97,
    slug: "v0-vercel",
    ...
    badge: "Community Score",
    rating: 4.3,
    price: "Free tier / Pro from $20mo",
    priceTier: "freemium",
    desc: "AI UI generator from Vercel that turns text prompts into React components styled with Tailwind CSS and shadcn/ui.",
    longDesc: "v0 focuses narrowly on UI generation — describe a component or page and it produces working React/Tailwind code you can copy into a project or deploy directly to Vercel. It's most useful for quickly scaffolding interface ideas rather than full application logic. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Coding","UI","React"],
    affiliateLink: "https://v0.dev/?ref=shabellehub",
    website: "https://v0.dev",
    hot: false,
    featured: false,
    pros: ["High-quality React/Tailwind output","Tight Vercel deployment integration","Good starting point for UI work"],
    cons: ["Narrow scope — UI generation only","Best results require Tailwind familiarity"],
    useCases: ["UI prototyping","React component scaffolding","Design-to-code workflows"],
    seoKeywords: ["v0 vercel review","ai ui generator"],
    alternatives: [],
  },
  {
    id: 98,
    ...
    badge: "Community Score",
    rating: 4.1,
    price: "Free / Build from $20mo",
    priceTier: "freemium",
    desc: "AI features built into the Warp terminal, offering natural-language-to-command translation and error explanation.",
    longDesc: "Warp is a modern terminal app with AI built in — you can describe what you want in plain English and get a suggested shell command, or ask it to explain a cryptic error message. It's aimed at developers who spend significant time in the terminal and want AI help without leaving it. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Coding","Terminal","CLI"],
    affiliateLink: "https://www.warp.dev/?ref=shabellehub",
    website: "https://www.warp.dev",
    hot: false,
    featured: false,
    pros: ["AI built into a modern terminal UI","Explains errors in plain language","Fast natural-language-to-command"],
    cons: ["Requires switching to Warp as your terminal","Mac/Linux focus, Windows support newer"],
    useCases: ["Terminal-heavy workflows","Shell command discovery","DevOps and SRE work"],
    seoKeywords: ["warp ai terminal review"],
    alternatives: [],
  },
  {
    id: 99,
    ...
    badge: "Community Score",
    rating: 3.9,
    price: "Free tier / Premium from $9.99mo",
    priceTier: "freemium",
    desc: "AI rewriting tool that suggests alternative phrasings for sentences to improve clarity and tone.",
    longDesc: "Wordtune works sentence-by-sentence, offering rewrite suggestions that let you pick a tone (formal, casual, shorter, longer) rather than generating full drafts from scratch. It's designed as a lightweight companion for polishing existing writing rather than a full drafting tool. This listing is compiled from publicly available information rather than hands-on testing — see our Featured Tools for entries our team has personally tested.",
    tags: ["Writing","Rewriting","Tone"],
    affiliateLink: "https://www.wordtune.com/?ref=shabellehub",
    website: "https://www.wordtune.com",
    hot: false,
    featured: false,
    pros: ["Simple, focused sentence rewriting","Good tone-adjustment options","Lightweight browser extension"],
    cons: ["Not designed for long-form drafting","Free tier has daily limits"],
    useCases: ["Sentence-level polish","Tone adjustment","Email and message rewriting"],
    seoKeywords: ["wordtune review"],
    alternatives: [],
  },
  {
    id: 100,
    ...
    badge: null,
    rating: 4.1,
    price: "Included with paid Zoom plans",
    priceTier: "paid",
    desc: "AI assistant built into Zoom for meeting summaries, smart chat replies, and in-meeting Q&A.",
    longDesc: "AI Companion is Zoom's built-in assistant, generating meeting summaries and action items automatically and letting you ask questions about a meeting after it ends. Because it is bundled with many existing Zoom plans, it is often the lowest-friction way for a team already on Zoom to get AI meeting notes without adopting a separate tool.",
    tags: ["Meetings","Productivity","Summarization"],
    affiliateLink: "https://www.zoom.com/en/products/ai-assistant/?ref=shabellehub",
    website: "https://www.zoom.com/en/products/ai-assistant/",
    hot: false,
    featured: false,
    pros: ["Included with many Zoom plans","Good meeting summaries and action items","Integrates with existing Zoom workflow"],
    cons: ["Tied to Zoom ecosystem","Summary quality varies with audio clarity"],
    useCases: ["Meeting summaries","Post-meeting Q&A","Action item tracking"],
    seoKeywords: ["zoom ai companion review","zoom ai meeting notes","zoom ai vs otter"],
    alternatives: ["otter","fireflies"],
  },
];
...
export const categories = [
  ...
  {
    name: "Image Generation", icon: "🎨", count: 6,
  ...
  {
    name: "Video Generation", icon: "🎬", count: 10,
  ...
  {
    name: "Productivity", icon: "⚡", count: 8,
  ...
  {
    name: "Data Analysis", icon: "📉", count: 4,
  ...
  },
  {
    ...
    description: "AI writing tools for drafting, editing, research, and creating high-quality content with the help of artificial intelligence.",
  },
];
